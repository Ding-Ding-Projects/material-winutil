...
const bridge: Bridge = {
  ...
  externalEditorsState: () => ipcRenderer.invoke('external-editors:state'),
  externalEditorsSelect: (editorId) => ipcRenderer.invoke('external-editors:select', editorId),
  externalEditorsPickConfigured: () => ipcRenderer.invoke('external-editors:pick-configured'),
  openExportInExternalEditor: (filePath) => ipcRenderer.invoke('view:export-open-external-editor', filePath),
  ...
  authenticatorCollection: () => ipcRenderer.invoke('authenticator:collection'),
  authenticatorOrganize: (request) => ipcRenderer.invoke('authenticator:organize', request),
